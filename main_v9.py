...
if __name__ == '__main__':
    ...
    # parser.add_argument('--inp_ch', type=int, default=10)
    parser.add_argument('--inp_ch', type=int, default=24)  # x2 (departure, destination)
    ...
    parser.add_argument('--f_coord', type=int, default=2)#64)
    parser.add_argument('--f_temporal', type=int, default=16)#32)#64)
    parser.add_argument('--f_gnblock', type=int, default=32)#64)#128)
    ...
    # Learning parameters
    parser.add_argument('--lr', type=float, default=1e-4)#0.01)#1e-4)
    ...
    parser.add_argument('--model_name', type=str, default='tgnet1077')
    ...
    parser.add_argument('--traindataname', type=str, default='in_and_out3_0%_1000m_10min_train_2015-01-01_2015-02-09.npy')   # (sequence, longitude#, latitude#, feature depth)  # predict the next or next-next one
    #parser.add_argument('--testdataname', type=str, default='in_and_out3_0%_1000m_10min_test_2015-02-09_2015-03-01.npy')       # (sequence, longitude#, latitude#, feature depth)
    parser.add_argument('--testdataname', type=str, default='in_and_out3_0%_1000m_10min_test2_2015-03-01_2015-04-01.npy')       # (sequence, longitude#, latitude#, feature depth)
    parser.add_argument('--time_step', type=int, default=10)  # 5 min
    parser.add_argument('--pred_ahead', type=int, default=1)  # 2 * args.time_step
    ...
    parser.add_argument('--sampling_rate', type=str, default='0.15%') #0.1%)
    args = parser.parse_args()

    args.traindataname = f'in_and_out3_{args.sampling_rate}_1000m_10min_train_2015-01-01_2015-02-09.npy'
    if not args.test:
        args.testdataname = f'in_and_out3_{args.sampling_rate}_1000m_10min_test_2015-02-09_2015-03-01.npy'
        args.test_stdate = "2015-02-09"
    else:
        args.testdataname = f'in_and_out3_{args.sampling_rate}_1000m_10min_test2_2015-02-09_2015-03-01.npy'
    ...
    args.model_input_shape = (args.lat_grid, args.long_grid, args.inp_ch)   # 2 is padding
    args.temporal_shape = 57
    args.coord_shape = (args.lat_grid, args.long_grid, 2)   # (long, lat)
